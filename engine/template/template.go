...
func NewTemplateEngine() *TemplateEngine {
	eng := &TemplateEngine{
		DelimStart: "{%",
		DelimEnd:   "%}",
		TagMap:     make(map[string]EngineTag),
...
func (eng *TemplateEngine) RegisterSingleTag(newTag EngineTag) {
...
func (eng *TemplateEngine) RegisterTags(tags []EngineTag) {
	for _, t := range tags {
